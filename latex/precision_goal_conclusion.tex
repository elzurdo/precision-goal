...
Moreover, unlike NHST (see Appendix~\ref{app:nhst}), which can only reject or fail to reject the null,
...
setting and grows exponentially. At $\omega_{\rm goal}=0.10$, PitG yields no conclusive

...
These figures correspond to a ROPE width of $\Delta_{\rm ROPE}=0.1$ and a precision goal of $\omega_{\rm goal}=0.08$, i.e.\ a $\pm 4$ percentage
...
conclusiveness ratio (ePitG/PitG) ranges from $1.17\times$ at the tightest
...
or an honest inconclusive --- is required and the cost per observation is low enough

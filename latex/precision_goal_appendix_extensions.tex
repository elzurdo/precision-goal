...
\begin{equation}\label{eq:ngoal_two_group_binomial}
    N_{\rm goal} \approx \frac{4 z_{*}^{2}[\theta_1(1-\theta_1)+\theta_2(1-\theta_2)]}{\omega_{\rm goal}^{2}}.
\end{equation}
...
\begin{equation}\label{eq:ngoal_two_group_continuous}
    N_{\rm goal} \approx \frac{4 z_{*}^{2}(\sigma_1^2+\sigma_2^2)}{\omega_{\rm goal}^{2}},
\end{equation}

...
continues until the HDI is narrower than $\omega_{\rm goal}$ \textit{and} its
...
across the full $\omega_{\rm goal}=0.06$--$0.10$ range over which PitG's collapses
from $82.5\%$ to zero, and is largest near the ROPE boundaries where evidence is
hardest to read.

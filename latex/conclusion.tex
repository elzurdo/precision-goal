...
We have proposed Enhanced Precision is the Goal (ePitG), which recouples the two
...
This advantage of ePitG over PitG is robust across precision goals: looser goals (larger $\omega_{\rm goal}$) worsen PitG's
...
conclusiveness ratio (ePitG/PitG) is $1.17\times$ at the tightest
setting and grows rapidly with $\omega_{\rm goal}$.
At $\omega_{\rm goal}=0.10$, PitG yields no conclusive outcomes while ePitG
remains 97.9\% conclusive (Table~\ref{tab:goal_impact}).

Both ePitG and PitG share an important analytical property: the expected precision-goal

...
PitG decouples the stopping criterion from the decision criterion, eliminating the
early-peeking bias of coupled methods \citep{kruschke2015doing}, but at an inconclusive
rate ranging from $17.5\%$ to $100\%$ across $\omega_{\rm goal}=0.06$--$0.10$ in the
fair-coin case --- most critically when the null is true.

...
precision target and a decisive hypothesis outcome --- acceptance or rejection of the
null --- to be satisfied simultaneously before stopping.
...
rate to just $2.3\%$, at a median sampling cost of only $4\%$ over the expected minimum
sample size $N_{\rm goal}$, while preserving a zero false-positive rate ---
the coupled stopping approach achieves comparable conclusiveness but at a
$6.2\%$ false-positive cost under the same conditions.
...
We provide a closed-form planning formula ($N_{\rm goal} \propto 1/\omega_{\rm goal}^2$),
an online interactive calculator, and open-source code to support prospective planning

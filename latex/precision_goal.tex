...
Throughout I use the term "Enhanced Precision is the Goal" (ePitG) to refer to the method
...
Alternative title suggestions are welcome. E.g, I was also considering:
"Improved Sequential Hypothesis Testing with ``Enhanced Precision Is The Goal''" 
...
Finally, you may want to play with the dedicated online calculator at https://r-w-t-y.streamlit.app/ .
Note that the experiments here focus on single-group dichotomous data,
but in the calculator I extend the method extends to continuous data and two-group comparisons as well,
...
The next missing feature I have in mind is advising the minimal more data needed to collect based
on their goal. Another feature to implement is advise on how to set the goal precision, as I believe

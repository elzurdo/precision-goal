...
are collected. When $\theta_{\rm null}=0.5$, this quantity is maximised at the null,
so the planned budget $N_{\rm goal}(\theta_{\rm null})$ is a conservative upper bound;
for other nulls, it may instead serve as a lower bound, and $N_{\rm max}$ should be set
accordingly.

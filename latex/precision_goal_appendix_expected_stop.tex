\section{Derivation of Expected Stop Iteration}\label{app:expected_stop}
...
\begin{figure}[h!]
  ...
  \caption{Expected stop iteration $N_{\rm goal}(\theta_{\rm true}, \omega_{\rm goal})$
  (Equation~\ref{eq:expected_stop_iteration_binomial}) as a function of

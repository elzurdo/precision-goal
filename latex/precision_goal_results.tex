...
So far we've demonstrated for the binomial case that the ePitG is both more decisive and
and is moderately less biased than PitG, but it also may come at the cost of more samples.
In Figure \ref{fig:stop_iterations_by_truth_conclusive} we visualise stop iteration statistics of each algorithm across $\theta_{\rm true}$ values.
...
In Figure \ref{fig:stop_conclusiveness_ratios} we address the issue of the benefit of
